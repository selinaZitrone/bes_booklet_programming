...
- Elaboration: Provide a short discussion on how using automated tools (linters/formatters) can help enforce style rules across a codebase.
  
## Have a naming convention

- Clear and Descriptive Names:
  - Point to add: Stress the importance of using names that clearly indicate the purpose or content of variables, functions, and modules.
  - Elaboration: Include examples showing the difference between vague names (e.g., temp, data1) and descriptive ones (e.g., temperature_readings, user_data).
- Consistency Across Projects:
  - Point to add: Recommend establishing and following naming conventions throughout a project. This can include rules for capitalization (snake_case vs. camelCase) and abbreviations.
  - Elaboration: Provide a side note or call-out box for each language if there are community-preferred naming styles (e.g., snake_case in Python, lowerCamelCase in JavaScript but note any specifics for R and Julia).
